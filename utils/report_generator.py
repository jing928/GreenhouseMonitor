...
class ReportGenerator:
    ...
    def generate(self):
        ...
        if sensor_data_range is None:
            ...
            return
        for day in days:
            self.__process_day(day, sensor_data_range)
            FileAccess.write_to_csv(self.__report_data, 'output.csv')
    ...
    def __process_day(self, day, data_range):
        ...
        day_status = Validator.verify_temp_humid_of_day(min_temp, max_temp,
